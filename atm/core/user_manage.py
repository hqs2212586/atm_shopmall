...
def register_account():
    ...
    while count < 3:
        account = input("\033[32;1m Please input account id:\033[0m")
        count += 1
        if account.isdigit():
            if account in all_account_list:
                ...
                account_data = account_sample.acc_dic
...
def reset_passwd():
    ...
    if account not in all_account_list:
        ...
        # {'status': 0, 'data': {'id': '1001', 'password': 'abc', 'credit': 15000, 'balance': 15000, 'enroll_date': '2018-03-10', 'expire_date': '2020-12-04', 'pay_day': 22, 'status': 0}}
